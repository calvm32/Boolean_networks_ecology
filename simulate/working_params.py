...
# probabilities
p_infected = 0.0                            # NEED TO FIND # chance a hibernating bat gets infected (given that WNS is on) on any given day
p_dead = 0.005                              # NEED TO FIND # chance that an infected bat dies on any given day
...
contact_rate = 20       # NEED TO FIND # population-dependent rate of contact btwn health bat and WNS infected bat or surface
